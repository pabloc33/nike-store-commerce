...
import { setAddItemToCar, setOpenCart } from "../app/cartSlice";
      ...
      >
        ...
        >
          ...
          <div className="flex item-center justify-between w-28 my-2">
            <div className="flex item-center bg-white/80 px-1 rounded blur-effect-theme">
